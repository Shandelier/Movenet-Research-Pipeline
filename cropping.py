...
def determine_torso_and_body_range(
    ...
    max_body_yrange = 0.0
    max_body_xrange = 0.0
    for joint in du.KEYPOINT_DICT.keys():
        if keypoints[0, 0, du.KEYPOINT_DICT[joint], 2] < MIN_CROP_KEYPOINT_SCORE:
            continue
        dist_y = abs(center_y - target_keypoints[joint][0])
        dist_x = abs(center_x - target_keypoints[joint][1])
...
def determine_crop_region(
    ...
    for joint in du.KEYPOINT_DICT.keys():
        target_keypoints[joint] = [
            keypoints[0, 0, du.KEYPOINT_DICT[joint], 0] * image_height,
            keypoints[0, 0, du.KEYPOINT_DICT[joint], 1] * image_width
        ]
